...
const VerifySponsor = () => {
  ...
  const bulkRegistration = async ()=>{
    ...
    try {
      ...
      for (let i = 658; i <= 1000; i++) { // limit to first 10 users for example
  ...
  const bulkPlanetBuy = async () =>{
    try {
      ...
      for (let i = 1372; i <=1800; i++) { 
        let userDetailsBN = await cosmosInstance!.WalletdetailsUser(1,i);
      ...
      if(userAddress === "0x148D21A4BDBA4861D4847717881b53081e9D44a7"){
        userAddress = "0x850A59edf39d8aD46Df80988D7ed90d95C5c3F32"
      }

      if(userAddress === "0x43E7BbeE7De1EB6e0445d47C732f03f10eCAB470"){
        userAddress = "0x148D21A4BDBA4861D4847717881b53081e9D44a7"
      }
